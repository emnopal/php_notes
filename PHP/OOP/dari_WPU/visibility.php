<?php
    ...
    */
    ...
    class KomikVisibility extends ProdukVisibility {
        public $jmlHalaman;
    ...
    class GameVisibility extends ProdukVisibility {
        public $waktuMain;
    ...
    class CetakInfoProdukVisibility {
    ...
    $produk1 = new KomikVisibility("Naruto", "Masashi Kishimoto", "Shonen Jump", 30000, 100);
    $produk2 = new GameVisibility("Uncharted", "Neil Druckmann", "Sony Computer", 250000, 50);
